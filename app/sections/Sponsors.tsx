...
const TIERS: { sponsors: Sponsor[]; height: string; gap: string }[] = [
  ...
  },
  {
    ...
    sponsors: [
      ...
      { name: "Council", url: "https://council.health", file: "council" },
      { name: "Neon", url: "https://neon.com", file: "neon" },
      { name: "Photon", url: "https://photon.codes", file: "photon" },
      { name: "Freesolo", url: "https://freesolo.co", file: "freesolo" },
      { name: "Relay", url: "https://relayapp.im", file: "relay" },
      ...
      { name: "Salesforce", url: "https://www.salesforce.com", file: "salesforce" },
      { name: "ElevenLabs", url: "https://elevenlabs.io", file: "elevenlabs" },
    ],
  },
];
